		...
		<ul class="headerlogin">
			...
			<li>
				<div class="logindropdown">
					<button class="dropbutton1">Sign in</button>
					<div class="dropdowncontent">
						<a href="customersignup.jsp">Customer Sign up</a> <a
							href="customersignin.jsp">Customer Sign in </a> <a
							href="adminlogin.jsp">Admin Sign in </a> <a href="security.jsp">Add
							Security</a>
					</div>
				</div>
			</li>
			...
			<li><a href="cart.jsp"><i class="fa fa-shopping-cart"
					style="font-size: 18px"></i> CART</a></li>
		</ul>
	</div>
