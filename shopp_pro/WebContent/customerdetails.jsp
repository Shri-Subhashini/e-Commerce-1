...
<title>Shopp | Customer Details</title>
		...
		<table style="table-layout: fixed; width: 100%;">
			<c:forEach items="${result.rows }" var="row">
				<tr>
					...
					<td style="width: 100px;"><c:out value="${row.customerName }"></c:out></td>
					<td style="width: 100px;"><c:out value="${row.customerPhone }"></c:out></td>
					<td style="width: 100px;"><c:out value="${row.customerMail }"></c:out></td>
					<td style="width: 100px;"><a
						href="<%= request.getContextPath() %>/AdminController?page=customerdelete&customerId=${row.customerId}"
