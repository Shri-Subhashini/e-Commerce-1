...
<body>
	<div id="header">
		...
		<ul class="headerlogin">
			<li>
				<a href="adminindex.jsp">Product Details</a>					
			</li>
			<li>
			...
			<li>
				<a href="AdminController?page=admin-login-out"><i class="fa fa-sign-out " style="font-size:18px"></i>LOG OUT</a>
			</li>
		</ul>
	</div>	
	
	<sql:setDataSource user="root" password="Subha@2127" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3307/test" var="ds"/>
		 ...
		 <table>
		  ...
		  <table style="table-layout: fixed;width: 100%;">
		  	 <c:forEach items="${result.rows }" var="row">
				<tr>
					<td style="width: 100px;"><c:out value="${row.customerId }"></c:out></td>
					...
					<td style="width: 100px;"><c:out value="${row.pinCode }"></c:out></td>						
				</tr>
			</c:forEach>		
			</table>
